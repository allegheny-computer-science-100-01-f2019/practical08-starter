# cs100f2019-practical8

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter materials for Practical 8 in Computer Science 100.
...
shapes and a program called `DisplaySymbolsMain` that reads in a symbol 
and a number from from a terminal and calls the appropriate methods in the 
`DisplaySymbols` class. Please see the comments in the
source code and the laboratory assignment sheet for more details. As verified by
[Checkstyle](https://github.com/checkstyle/checkstyle), the source code for the
`DisplaySymbols.java` and `DisplaySymbolsMain` files must adhere to all of the requirements in the [Google
...
```
Janyl Jumadinova Thu Oct 24 15:39:10 EDT 2019

Please enter a symbol to display.
Okay, I read in the symbol $.

Please enter the number of rows to display.
Okay, I read in the row count of 30.
...
Starter](https://github.com/allegheny-computer-science-100-01-f2019/practical08-starter)
